...
export default function UseStateHook() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.btn, styles.btnMutilplica]} onPress={() => { setValor(valor * 2); }}>
        <Text style={styles.btnText}>Mutiplicar Valor</Text>
      </TouchableOpacity>
      <TouchableOpacity style={[styles.btn, styles.btnDivide]} onPress={() => { setValor(valor / 2); }}>
        <Text style={styles.btnText}>Dividir Valor</Text>
      </TouchableOpacity>
    </View>
  );
}
